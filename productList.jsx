...
class ProductsList extends Component {
  ...
  handleGoBack = () => {
    this.setState({ selectedProduct: null, isPopupVisible: false });
  };
  togglePaymentPage = () => {
  ...
  render() {
    ...
    return (
      <div>
        <div className="products-list" style={this.state.selectedProduct ? { display: 'none' } : {}}>
        ...
        {this.state.selectedProduct && !this.state.showPaymentPage && (
        <ProductDetailsPopup
      ...
      {this.state.showPaymentPage && (
        <PaymentPage productId={this.state.selectedProduct.id}/>
      )}
      </div>
    );
  }
